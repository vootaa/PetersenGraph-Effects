...
// Pentagon distance field for the inner pentagon
...
float petersenCenterPentagon(vec2 p) {
    ...
    // Central pentagon vertices: radius 0.06, angles: 36°, 108°, 180°, 252°, 324°
    ...
    float pentagonDist = shrinkShape(sdPentagon(p, pentagon_a, pentagon_b, pentagon_c, pentagon_d, pentagon_e), shrink);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    vec3 col = mix(vec3(0.04, 0.01, 0.05), vec3(0.09, 0.01, 0.08), p.y * 0.2 + 0.5);
