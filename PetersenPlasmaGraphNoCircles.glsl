// PetersenPlasmaGraphNoCircles.glsl - Dynamic visualization of PetersenGraph without concentric circles
// Focuses on nodes and connections with plasma effects
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // 1. Draw arcs (removed circle drawing section)
    for(int i = 0; i < 30; i++) {
